...
export const CartsContainerMemory = class Carts {
  ...
  async createCart() {
    try {
      ...
      return { error: "Error al crear carrito: " + err };
    }
  }
  ...
  async getCartById(cart_id) {
    try {
      ...
      return { error: "Error al buscar carrito: " + err };
    }
  }
  ...
  async getProductsByCartId(cart_id) {
    try {
      ...
      return { error: "Error al buscar productos: " + err };
    }
  }
  ...
  async addToCart(id_cart, id_product) {
    ...
    try {
      ...
      return { error: "Error al agregar producto: " + err };
    }
  }
  ...
  async deleteProduct(id_cart, id_product) {
    ...
    try {
      ...
      return { error: "Error al borrar producto: " + err };
    }
  }
  ...
  async deleteAllProducts(id_cart) {
    ...
    try {
      ...
      return { error: "Error al vaciar carrito: " + err };
    }
  }
};
